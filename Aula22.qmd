...
::::{.columns}
:::{.column width='40%'}
- Três planos definidos por um sistema linear
- Dois planos são quase coincidentes
- Deslocamento no ponto de interseção
:::
:::{.column width='60%'}
![](figs/Aula22/malcondicionamento.png){fig-align="center"}
:::
::::
...
e 
$$
\vert \delta b \Vert \le \Vert A^{-1}\Vert \Vert \delta b\Vert
$$
...
$$
\frac{\Vert\delta x\Vert_2}{x + \delta x} \le \kappa_2(A)\frac{\Vert\delta A\Vert_2}{\Vert A\Vert_2} = 1,9206\cdot 10^4\frac{10^{-2}}{1,9801}
$$

$$
\frac{\Vert\delta x\Vert_2}{x + \delta x} \le 1,9800\cdot 10^2
$$
...
$$
\frac{\Vert\delta x\Vert_2}{x + \delta x} = \frac{1,4214}{2,0000} = 7,1070\cdot 10^{-1}
$$
