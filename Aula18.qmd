...
![](figs/Aula18/solucao_unica.png){fig-align="center"}
...
- A pivotação parcial garante qu eo pivô seja não nulo, exceto quando a matriz for singular
...
Resolver o sistem apelo método de Gauss com pivotação parcial
$$
\begin{bmatrix}
1 & -3 & 2\\
-2 & 8 & -1\\ 
