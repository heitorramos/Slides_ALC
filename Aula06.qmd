...
$$ \Vert x\Vert_1 = \mid 2\mid + \mid -3\mid +\mid 1 \mid =6$$

$$ \Vert x\Vert_2 = \sqrt{\mid 2\mid^2 + \mid -3\mid^2 +\mid 1 \mid^2}= \sqrt{14} \approx 3,7417$$

$$ \Vert x\Vert_\infty = \max{\mid 2\mid + \mid -3\mid +\mid 1 \mid} =  3$$
