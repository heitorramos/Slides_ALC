...
- Vamos calcular $\beta_1$ e $\beta_2$ que minimize a soma dos quadrados dos resíduos

$$E = \sum_{i=1}^n (y_i -\beta_1x_1 - \beta_2)^2$$
:::
...
- A qualidade do ajuste é geralmente indicado pelo quadrado do coeficiente de correlação ($R^2$)
